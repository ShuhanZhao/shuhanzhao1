...
boxplot(cheng,col=c("yellow","steelblue","steelblue","mediumturquoise"),xlab="chip1$GSM816038,chip1$GSM816040,chip1$GSM816041,chip1$GSM816042" , ylab="Length of AA",las=1, font.lab=2)
